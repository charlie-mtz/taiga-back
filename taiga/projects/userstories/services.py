...
def update_userstories_kanban_order_in_bulk(project: Project,
    ...
    # exclude moved user storiesi and
    ...
    UPDATE userstories_userstory
       SET swimlane_id = tmp.new_swimlane_id::INTEGER,
           status_id = tmp.new_status_id::INTEGER,
           kanban_order = tmp.new_kanban_order::INTEGER
